...
class ResNet(Module):
    ...
    def __init__(self, block, layers, num_classes: int):
        ...
        self.fc = Linear(256 * block.expansion, num_classes)
...
def light_resnet14(num_classes: int):
    return ResNet(BasicBlock, [2, 2, 2], num_classes)


def light_resnet28(num_classes: int):
    return ResNet(BasicBlock, [4, 6, 3], num_classes)


def light_resnet41(num_classes: int):
    return ResNet(Bottleneck, [4, 6, 3], num_classes)


def light_resnet92(num_classes: int):
    return ResNet(Bottleneck, [4, 23, 3], num_classes)


def light_resnet143(num_classes: int):
